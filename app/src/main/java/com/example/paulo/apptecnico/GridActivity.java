...
public class GridActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new CheeseDynamicAdapter(this, new ArrayList<String>(Arrays.asList(Cheeses.sCheeseStrings)), getResources().getInteger(R.integer.column_count)));
