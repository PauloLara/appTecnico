...
public class SwipeAndDragHelper extends ItemTouchHelper.Callback {
    ...
    public static class DynamicGridView extends GridView {
        ...
        private com.example.paulo.apptecnico.DynamicGridView.OnDropListener mDropListener;
        private com.example.paulo.apptecnico.DynamicGridView.OnDragListener mDragListener;
        private com.example.paulo.apptecnico.DynamicGridView.OnEditModeChangeListener mEditModeChangeListener;
        ...
        private Stack<com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification> mModificationStack;
        private com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification mCurrentModification;

        private com.example.paulo.apptecnico.DynamicGridView.OnSelectedItemBitmapCreationListener mSelectedItemBitmapCreationListener;
        ...
        public void setOnDropListener(com.example.paulo.apptecnico.DynamicGridView.OnDropListener dropListener) {
            this.mDropListener = dropListener;
        }

        public void setOnDragListener(com.example.paulo.apptecnico.DynamicGridView.OnDragListener dragListener) {
        ...
        public void setOnEditModeChangeListener(com.example.paulo.apptecnico.DynamicGridView.OnEditModeChangeListener editModeChangeListener) {
        ...
        public void setUndoSupportEnabled(boolean undoSupportEnabled) {
            if (this.mUndoSupportEnabled != undoSupportEnabled) {
                if (undoSupportEnabled) {
                    this.mModificationStack = new Stack<com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification>();
                } else {
        ...
        public void undoLastModification() {
            if (mUndoSupportEnabled) {
                if (mModificationStack != null && !mModificationStack.isEmpty()) {
                    com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification modification = mModificationStack.pop();
        ...
        public void setOnSelectedItemBitmapCreationListener(com.example.paulo.apptecnico.DynamicGridView.OnSelectedItemBitmapCreationListener selectedItemBitmapCreationListener) {
            this.mSelectedItemBitmapCreationListener = selectedItemBitmapCreationListener;
        }

        private void undoModification(com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification modification) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mUndoSupportEnabled) {
                        if (mCurrentModification != null && !mCurrentModification.getTransitions().isEmpty()) {
                            ...
                            mCurrentModification = new com.example.paulo.apptecnico.DynamicGridView.DynamicGridModification();
                        }
                    }
        ...
        private void handleCellSwitch() {
            ...
            if (targetView != null) {
                ...
                com.example.paulo.apptecnico.DynamicGridView.SwitchCellAnimator switchCellAnimator;
        ...
        private class PreHoneycombCellAnimator implements com.example.paulo.apptecnico.DynamicGridView.SwitchCellAnimator {
            private int mDeltaY;
            private int mDeltaX;
        ...
        private class KitKatSwitchCellAnimator implements com.example.paulo.apptecnico.DynamicGridView.SwitchCellAnimator {
            ...
            public void animateSwitchCell(final int originalPosition, final int targetPosition) {
                ...
                getViewTreeObserver().addOnPreDrawListener(new KitKatSwitchCellAnimator.AnimateSwitchViewOnPreDrawListener(mMobileView, originalPosition, targetPosition));
                mMobileView = getViewForId(mMobileItemId);
            }
        ...
        private class LSwitchCellAnimator implements com.example.paulo.apptecnico.DynamicGridView.SwitchCellAnimator {
            ...
            @Override
            public void animateSwitchCell(final int originalPosition, final int targetPosition) {
                getViewTreeObserver().addOnPreDrawListener(new LSwitchCellAnimator.AnimateSwitchViewOnPreDrawListener(originalPosition, targetPosition));
            }
