...
public class Cadastro extends AppCompatActivity {
    ...
    //String url = "https://appscout.000webhostapp.com/appscout/cadastro.php";
    ...
    public void UserLogin() {
        ...
        //Toast.makeText(Cadastro.this, nomeClube, Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(final String response) {
                ...
                if(response.contains("Cadastrado com sucesso")){
                    txtNome.setText("");
                    txtEmail.setText("");
                    txtSenha.setText("");
